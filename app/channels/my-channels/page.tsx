    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">내가 속한 채널</h2>
            <p className="text-slate-600">참여 중인 채널 목록입니다</p>
          </div>
          <Link
        ...
        {loading ? (
          ...
          <div className="rounded-2xl bg-white p-12 text-center shadow-sm border border-slate-200">
            <p className="text-slate-600 mb-4">참여 중인 채널이 없습니다.</p>
            <Link
              href="/channels"
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {channels.map((channel) => (
              <Link
                ...
                className="group block rounded-2xl bg-white p-6 shadow-sm border border-slate-200 hover:shadow-xl hover:border-indigo-300 transition-all transform hover:-translate-y-1"
              >
